...
export function DevicePolicyModal({ device, onClose }: { device: Device; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center bg-black/40 p-0 lg:p-4">
      <div className="flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-t-2xl rounded-b-none animate-sheet-up pb-safe lg:animate-none lg:rounded-lg lg:pb-0 bg-white shadow-xl">
